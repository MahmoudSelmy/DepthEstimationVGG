...
class Vgg16Model:
    ...
    def build(self, input_tensor, trainable=False, isTraining=True):
        ...
        self.conv5_2 = self.conv2d(self.conv5_1, 'conv5_2', n_channel=512, n_filters=512, isTraining=trainable,trainable=trainable,
                                   reuse=False)
        self.conv5_3 = self.conv2d(self.conv5_2, 'conv5_3', n_channel=512, n_filters=512, isTraining=trainable,trainable=trainable,
        ...
        self.pred_conv = helper.conv2d(input=self.pad, filter_size=3, number_of_channels=512, number_of_filters=512,
                                       padding='SAME',
                                       max_pool=False, layer_name='conv_Pred', batch_norm=False, isTraining=trainable,trainable=trainable)
        ...
        self.deconv_branch1 = helper.add_deconvolutional_layer(self.conv_branch1,name='deconv_branch1',kernel_size=1,no_channels=32,no_filters=32,scale=scale)
        #Branch2
        scale *= 2
        ...
        self.conv_branch2 = helper.conv2d(input=self.pred3, filter_size=3, number_of_channels=256,
                                          ...
                                          isTraining=isTraining, trainable=True)
        self.deconv_branch2 = helper.add_deconvolutional_layer(self.conv_branch2,name='deconv_branch2',kernel_size=2*scale,no_channels=32,no_filters=32,scale=scale)
        #Branch3
        scale *= 2
        self.conv_branch3 = helper.conv2d(input=self.conv4_3, filter_size=3, number_of_channels=512,
                                          ...
                                          isTraining=isTraining, trainable=True)
        self.deconv_branch3 = helper.add_deconvolutional_layer(self.conv_branch3,name='deconv_branch3',kernel_size=2*scale,no_channels=64,no_filters=64,scale=scale)
        #Branch4
        scale *= 2
        self.conv_branch4 = helper.conv2d(input=self.conv5_3, filter_size=3, number_of_channels=512,
                                          ...
                                          isTraining=isTraining, trainable=True)
        self.deconv_branch4 = helper.add_deconvolutional_layer(self.conv_branch4,name='deconv_branch4',kernel_size=2*scale,no_channels=64,no_filters=64,scale=scale)
        #Branch5
        ...
        self.conv_branch5 = helper.conv2d(input=self.pred_conv, filter_size=3, number_of_channels=512,
                                          ...
                                          isTraining=isTraining, trainable=True)
        self.deconv_branch5 = helper.add_deconvolutional_layer(self.conv_branch4,name='deconv_branch5',kernel_size=18,no_channels=64,no_filters=64,scale=2)

        self.featues_stack = tf.concat([self.deconv_branch1,self.deconv_branch2,self.deconv_branch3,self.deconv_branch4,self.deconv_branch5],axis=3)
